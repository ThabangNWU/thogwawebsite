...
=============================================*/
     ...
     // Check if #slider-range exists before initializing the slider
     ...
     if (sliderRange.length > 0) {
         ...
         console.error('#slider-range element not found.');
     }

     // Check if #filter-button exists before adding the click event
     ...
     function applyFilter() {
         ...
         var filterUrl = '/product/filterMinMax?min=' + minPrice + '&max=' + maxPrice;

         // You can optionally add more parameters if needed
         // For example: filterUrl += '&pageSize=10&page=1';
